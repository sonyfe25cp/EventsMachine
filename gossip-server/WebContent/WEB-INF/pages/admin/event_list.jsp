...
<html>
<head>
    <link rel="stylesheet" type="text/css" href="css/admin/bootstrap.css" media="all">
	<link rel="stylesheet" type="text/css" href="css/admin/style.css" media="all">
	...
	<script type="text/javascript" src="js/admin/index1.js"></script>
