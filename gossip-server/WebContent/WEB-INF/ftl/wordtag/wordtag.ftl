...
<div class="container">
	...
	<ol class="breadcrumb">
	  <li><a href="/">新闻系统</a></li>
	  <li class="active">词语标注</li>
	</ol>
	<div class="page-header" style="margin-top:30px;">
         <h2 style="line-height:50px;">这是一个中文词语标注网页，如果您觉得页面上显示的词语对分析数据有用，请选择“保留”，若您觉得没用请选择“放弃”，否则，请选择“跳过”。</h1>
     </div>
     ...
     <div class="page-footer" style="margin-top:40px;">
         <p style="font-size:30px;"><strong>举例说明：</strong></p>
         <br>
